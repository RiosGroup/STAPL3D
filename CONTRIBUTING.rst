...
#. use the search functionality `here <https://github.com/RiosGroup/stapl3d/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the STAPL3D repository on GitHub;
