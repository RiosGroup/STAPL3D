...
projectdir = 'E:\\mkleinnijenhuis\\test'
dataset = 'HFK16w'
...
stitch_stem = '{}{}{}'.format(dataset, cfg['shading']['postfix'], cfg['stitching']['postfix'])
...
im_preproc ='{}{}.ims'.format(ims_stem, cfg['biasfield']['postfix'])
...
channels_pat = '{}*{}.ims'.format(dataset, cfg['biasfield']['postfix'])
